...
`bubblePlot.pathways.LR` is a handy way to visualize the strengths of several
...
`BulkSignalR` workflow can be applied to spatial transcriptomics to find
...
```
![spatial](../man/figures/spatialPlot1_clean.png)
\

## Additional functions

We provide function to assess statistical associations of L-R gene
...
latter in the form of a heatmap. We also provide 2D-projections to
assess diversity among L-R interaction spatial distributions over
an entire dataset or to generate a large index picturing all these distribution
